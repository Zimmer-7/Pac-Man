...
public class Entity {
	...
	public static BufferedImage mini_apple = Game.spriteSheet.getSprite(64, 16, 16, 16);
	public static BufferedImage mega_apple = Game.spriteSheet.getSprite(64, 0, 16, 16);
	...
	public boolean isCollidingWall(int xx, int yy) {
